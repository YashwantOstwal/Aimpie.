...
function OnHoverStrategy(props){
  return (
    <div className = 'overflow-hidden'>
      <div className = {`fixed top-[10%] right-[30%] ${props.cloudColor} md:p-[2%] lg:p-[3%] max-md:px-1 rounded-full w-fit`}>
        {props.constituents[0]}
      </div>
      <div className = {`fixed ${props.cloudColor} md:p-[2%] lg:p-[3%] max-md:px-1  rounded-full w-fit top-[25%] left-[5%]`} >
        {props.constituents[1]}
      </div>
      <div className = {`fixed ${props.cloudColor} md:p-[2%] lg:p-[3%] max-md:px-1  rounded-full w-fit top-[35%] left-[25%]`} >
        {props.constituents[2]}
      </div>
      <div className = {`fixed ${props.cloudColor} md:p-[2%] lg:p-[3%] max-md:px-1  rounded-full w-fit bottom-[40%] right-[10%]`} >
